...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'blog_article', ['title'])


    def backwards(self, orm):
        # Removing unique constraint on 'Article', fields ['title']
        db.delete_unique(u'blog_article', ['title'])
    ...
    models = {
        u'blog.article': {
            ...
            'bodySummary': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'url': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '1000', 'blank': 'True'})
        },
        u'blog.comment': {
